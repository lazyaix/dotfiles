...
---@field focus_color string background color when in focus mode. Default is `colors.background`
...
function BackDrops:_create_opts()
   -- Fall back to focus (solid color) when no images are available
...
---Cycle forward to next background
---@param window any WezTerm `Window`
...
---Cycle backward to previous background
---@param window any WezTerm `Window`
